...
public class ActivityBeautePeauList extends  Activity {
	ListView listViewBeautePeauList=null;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_beaute_peau_list);
...
listViewBeautePeauList = (ListView) findViewById(R.id.listViewBeautePeau);
      ...
      //Création d'un SimpleAdapter qui se chargera de mettre les items présent dans notre list (listItem) dans la vue affichageitem
        ...
        listViewBeautePeauList.setAdapter(mScheduleTestSerie);
		
		
		
        listViewBeautePeauList.setOnItemClickListener(new OnItemClickListener() {
			@Override
        	@SuppressWarnings("unchecked")
         	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
				//on récupère la HashMap contenant les infos de notre item (titre, description, img)
        		HashMap<String, String> map = (HashMap<String, String>) listViewBeautePeauList.getItemAtPosition(position);
        ...
        case 0:
          ...
          // Toast.makeText(this,"Position de l'element "+values[position]+" "+position , Toast.LENGTH_LONG).show();
    		   	...
    		   	Intent IntentActivityAloaloeveraera = new Intent(ActivityBeautePeauList.this,ActivityAloaloeveraera.class);
        ...
        case 1:  
            ...
            //Toast.makeText(this,"Position de l'element "+values[position]+" "+position , Toast.LENGTH_LONG)
             // .show();
           Intent IntentActivityAvoine= new Intent(ActivityBeautePeauList.this,ActivityAvoine.class);
        ...
        case 2:  
           ...
           //Toast.makeText(this,"Position de l'element "+values[position]+" "+position , Toast.LENGTH_LONG)
            // .show();
          Intent IntentActivityBardane= new Intent(ActivityBeautePeauList.this,ActivityBardane.class);
        ...
        case 3:  
              ...
              //Toast.makeText(this,"Position de l'element "+values[position]+" "+position , Toast.LENGTH_LONG)
               // .show();
             Intent IntentActivityBourrache= new Intent(ActivityBeautePeauList.this,ActivityBourrache.class);
        ...
        case 4:  
            ...
            //Toast.makeText(this,"Position de l'element "+values[position]+" "+position , Toast.LENGTH_LONG)
             // .show();
           Intent IntentArretStationnement= new Intent(ActivityBeautePeauList.this,ActivityNoyer.class);
