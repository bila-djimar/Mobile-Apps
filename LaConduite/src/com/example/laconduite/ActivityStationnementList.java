...
public class ActivityStationnementList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mapTestSerieStationnement.put("titre", "Série 1");
        //on insère un élément description que l'on récupérera dans le textView description créé dans le fichier affichageitem.xml
        mapTestSerieStationnement.put("description", " Commencer la Série 1");
      ...
      //enfin on ajoute cette hashMap dans la arrayList
        ...
        mapTestSerieStationnement = new HashMap<String, String>();
        mapTestSerieStationnement.put("titre", "Série 2");
        mapTestSerieStationnement.put("description", " Commencer la Série 2");
        mapTestSerieStationnement.put("img", String.valueOf(R.drawable.serie2));
        listItemStationnementSerieTest.add(mapTestSerieStationnement);  
        
        
        mapTestSerieStationnement = new HashMap<String, String>();
        mapTestSerieStationnement.put("titre", "Série 3");
        mapTestSerieStationnement.put("description", " Commencer la Série 3");
        mapTestSerieStationnement.put("img", String.valueOf(R.drawable.serie3));
        listItemStationnementSerieTest.add(mapTestSerieStationnement);  
        
        
        mapTestSerieStationnement = new HashMap<String, String>();
        mapTestSerieStationnement.put("titre", "Série 4");
        mapTestSerieStationnement.put("description", " Commencer la Série 4");
        mapTestSerieStationnement.put("img", String.valueOf(R.drawable.serie4));
        listItemStationnementSerieTest.add(mapTestSerieStationnement);  
        
        
        mapTestSerieStationnement = new HashMap<String, String>();
        mapTestSerieStationnement.put("titre", "Série 5");
        mapTestSerieStationnement.put("description", " Commencer la Série 5");
